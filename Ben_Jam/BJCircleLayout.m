...
#import "BJCircleLayout.h"


@interface BJCircleLayout ()
...
- (void)prepareLayout
{
    ...
    itemWidth = MIN(itemWidth, MIN(gridWidth, gridHeight)) / 2.0;
    ...
    CGFloat radius = MIN(size.height, size.width)/2.0 - itemWidth;
    ...
    for (NSInteger i = 0; i < itemCount; i++)
    {
        ...
        CGFloat x = cos(M_PI * 2.0 /itemCount * i) * radius + (size.width/2.0);
        
       
        CGFloat y = sin(M_PI * 2.0 /itemCount * i) * radius + (size.height/2.0);
